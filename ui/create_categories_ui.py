...
class CreateCategoriesUI(QtWidgets.QDialog):

    def __init__(self, parent=None):
        super(CreateCategoriesUI, self).__init__(parent)
    ...
    def create_widgets(self):
        ...
        self.publish_slots_lb = QtWidgets.QLabel("Xchange")
        ...
        self.task_pub_slots_wdg = QtWidgets.QTableWidget()
        self.task_pub_slots_wdg.setColumnCount(2)
        self.task_pub_slots_wdg.setHorizontalHeaderLabels(["Category Name", "Type"])
        self.task_pub_slots_wdg.setShowGrid(False)
        self.task_pub_slots_wdg.setAlternatingRowColors(True)
        header = self.task_pub_slots_wdg.verticalHeader()
        header.hide()
        self.task_pub_slots_wdg.setColumnWidth(0, 150)
        self.task_pub_slots_wdg.setColumnWidth(1, 150)
    ...
    def get_current_pub_slots(self):
        ...
        if pub_slots != None:
            ...
            self.task_pub_slots_wdg.setDisabled(False)

            return pub_slots
        elif pub_slots == None:

            self.publish_slots_le.setDisabled(True)
            self.task_pub_slots_wdg.setDisabled(True)
...
if __name__ == "__main__":
    ...
    create_shot = CreateCategoriesUI()
    create_shot.show()
    sys.exit(app.exec_())