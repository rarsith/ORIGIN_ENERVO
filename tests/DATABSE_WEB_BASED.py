...
# ... (AssetSchema and AssetViewModel as before)
class AssetSchema:
...
def assets_by_category(category):
    assets = asset_view_model.get_assets_by_category(category)
    return render_template('assets.html', category=category, assets=assets)
